...
# coding exercise: rock_paper_scissors
...
# 
# You receive an encrypted strategy guide (your puzzle input) that will be sure to help you win. 
# "The first column is what your opponent is going to play: A for Rock, B for Paper, and C for Scissors. 
# The second column--" Suddenly, your helper is called away.
# 
...
# 
# Since you can't be sure if the "helper" is trying to help you or trick you, 
...
puzzle_input <- "main/00_data/rock_paper_scissors.txt"
...
puzzle_input %>% 
  ...
  # measure result (0 = loss, 3 = draw, 6 = win)
  .[, result := 3 * ((1 + V4 - V3) %% 3)] %>% 
...
# Your helper returns: "Anyway, the second column says how the round needs to end: 
...
# 
# Following the helper's instructions for the second column, what would your total score be if 
...
puzzle_input %>% 
  ...
  # replace V4 with appropriate rock, paper, scissors pronumeral
  .[
    ,
    V4 := fcase(
      V2 == "X", ((V3 - 2L) %% 3L) + 1L,
